...
export const MEMBERSHIP_PLANS = [
  {
    ...
    description: '2 exterior washes + 1 interior detail per month',
    price: 9900,
    interval: 'month' as const,
    features: [
      '2 exterior hand washes',
      '1 interior detail',
  ...
  },
  {
    name: 'Premium Bundle',
    slug: 'premium-bundle',
    description: 'Home + auto care at one great price',
    price: 29900,
    interval: 'month' as const,
    features: [
      '2 home cleanings per month',
