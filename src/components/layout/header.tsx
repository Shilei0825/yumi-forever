...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-gray-200/80 bg-white/80 backdrop-blur-xl supports-[backdrop-filter]:bg-white/80">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        >
          <Image src="/logo-horizontal.png" alt={BRAND.name} width={180} height={48} className="h-10 w-auto sm:h-12" priority />
        </Link>
      ...
      <div
        className={cn(
          "fixed inset-0 top-16 z-[60] bg-white transition-all duration-300 ease-in-out md:hidden",
          mobileMenuOpen
      ...
      >
        <div className="flex h-[calc(100vh-4rem)] flex-col overflow-y-auto">
          ...
          <div className="border-t border-gray-100 px-6 py-6 safe-bottom">
            <a
              href={`tel:${BRAND.phone}`}
